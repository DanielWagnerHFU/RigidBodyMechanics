...
rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(x, y), new Vector2D(0, 0), new Vector2D(0, 0),
	...
	private void Brick() {
		...
		int x = 0;
		int y = 0;
	//	rigidBodies.add(new RigidBody(new Rectangle(5,1), Double.MAX_VALUE, new Vector2D(0, 0), new Vector2D(0, 0), new Vector2D(0, 0), 0, 0, 0));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(x, y), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(5, 1)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(0, 8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Triangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(3.1, 8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Triangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-3.1, 8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Triangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(6.2, 8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Triangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-6.2, 8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Triangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(1.1, 7.3), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-2.1, 7.3), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(4.2, 7.3), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-5.3, 7.3), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(3, 0.5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-5.5, 4), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 100, 0, 0, false, new Rectangle(5, 0.5)));
		
	//	rigidBodies.add(new RigidBody(new Rectangle(1,1), 0.5, new Vector2D(2, 3), new Vector2D(-1, -4), new Vector2D(0, -1), 0.4, 0, 0));
		rigidBodies.add(new RigidBody(new Rectangle(1,1), 0.5, new Vector2D(-6, 5.2), new Vector2D(0, 0), new Vector2D(0, -1), -0.5, 0, 0));
		
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(8.5, 5), new Vector2D(0, 0), new Vector2D(0, 0),
    			Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(0.5, 10)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(-8.5, 5), new Vector2D(0, 0), new Vector2D(0, 0),
    			Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(0.5, 10)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(0, 11), new Vector2D(0, 0), new Vector2D(0, 0),
    			Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(18, 0.5)));
	...
	private void Birds() {
		...
		int x = 0;
		int y = 0;
		rigidBodies.add(new RigidBody(new Rectangle(1,1), 20.5, new Vector2D(0, 1), new Vector2D(0, 0), new Vector2D(0, 0), 0.2, 0, 0));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(10, -0.8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(1, 5)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(15, 0.5), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(1, 8)));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(20, -0.8), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(1, 4)));
	//	rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(0, 1), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(1, 3)));
		rigidBodies.add(new RigidBody(new Triangle(1,1), 20.5, new Vector2D(15, 5.4), new Vector2D(0, 0), new Vector2D(0, 0), 0, 0, 0));
		rigidBodies.add(new RigidBody(Double.MAX_VALUE, new Vector2D(0, -4.2), new Vector2D(0, 0), new Vector2D(0, 0),Double.MAX_VALUE, 0, 0, 0, false, new Rectangle(80, 1)));
